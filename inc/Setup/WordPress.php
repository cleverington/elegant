 ...
 *
 * @package Elegant
 * @subpackage Elegant/Setup/WordPress
 */
...
class WordPress {
	...
	public function run() {
		...
		add_action( 'wp_loaded_max_upload', array( $this, 'set_max_upload_size_limit' ), 1 );
	...
	/**
	 * Set upload size-limit to 4mb, by default.
	 *
	 * Increase, if needed.
	 *
	 * @param num $size is the upload six limit in height and width.
	 * @return void
	 */
	public function set_max_upload_size_limit( $size ) : void {
		$size = 1024 * 4000;
		add_filter( 'upload_size_limit', $size, 20 );
	}
